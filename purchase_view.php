                ...
                <div class="col-md-6 mb-3">
                    <div class="info-box">
                        ...
                        <?php if ($vendorContact): ?>
                            <p class="mb-1"><strong>Contact:</strong> <?php echo htmlspecialchars($vendorContact); ?></p>
                        <?php endif; ?>
                        <?php if ($vendorPhone): ?>
                            <p class="mb-1"><i class="fas fa-phone me-2 text-muted"></i><?php echo htmlspecialchars($vendorPhone); ?></p>
                        <?php endif; ?>
                        <?php if ($vendorEmail): ?>
                            <p class="mb-1"><i class="fas fa-envelope me-2 text-muted"></i><?php echo htmlspecialchars($vendorEmail); ?></p>
                        <?php endif; ?>
                        <?php if ($vendorAddress): ?>
                            <p class="mb-0"><i class="fas fa-map-marker-alt me-2 text-muted"></i><?php echo htmlspecialchars($vendorAddress); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="info-box">
                        ...
                        <table class="table table-borderless table-sm mb-0">
                            ...
                            <tr>
                                ...
                                <td class="fw-bold"><?php echo date('F d, Y', strtotime($purchase['order_date'])); ?></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($purchaseStatus == 'Pending') $statusClass = 'bg-warning';
                                    if ($purchaseStatus == 'Ordered') $statusClass = 'bg-info';
                                    if ($purchaseStatus == 'Received') $statusClass = 'bg-success';
                                    ?>
                                    <span class="badge <?php echo $statusClass; ?>"><?php echo $purchaseStatus; ?></span>
                                </td>
                            </tr>
                            <tr>
                ...
                <table class="table table-po table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-light text-dark"><?php echo htmlspecialchars($productSku); ?></span></td>
                    ...
                    <div class="total-section">
                        <table class="table table-borderless mb-0">
                            <tr>
                                ...
                                <td class="text-end fw-bold"><?php echo $symbol . number_format($subtotal, 2); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr class="border-top">
                                ...
                                <td class="text-end fs-4 fw-bold text-primary"><?php echo $symbol . number_format($purchase['total_amount'], 2); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
